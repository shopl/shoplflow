...
function SvgIcMobileview(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 20 20" {...props}>
      ...
      />
      <path stroke="#999" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2h5v5" />
      <rect width={9} height={2} x={9.757} y={7.828} fill="#999" rx={1} transform="rotate(-45 9.757 7.828)" />
    </svg>
  );
}
