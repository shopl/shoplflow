...
function SvgImgTutorial01(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 100 100" {...props}>
      ...
      <rect width={13.8} height={13.8} x={20.35} y={59.1} stroke="#02B585" strokeWidth={1.2} rx={2.4} />
      <path
        stroke="#333"
        strokeLinecap="round"
      ...
      <rect width={13.8} height={13.8} x={20.35} y={38.1} stroke="#02B585" strokeWidth={1.2} rx={2.4} />
      <path
        stroke="#333"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <defs>
        ...
        >
          ...
          <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_1234_249" />
          <feBlend in="SourceGraphic" in2="effect1_dropShadow_1234_249" result="shape" />
        </filter>
      </defs>
    </svg>
  );
