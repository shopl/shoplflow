...
| Callout | Callout | 2.1.6 | 2.1 | 🟢 |
| Chips | ChipButton | 2.0.2 | 2.0 | 🟢 |
| Chips | ChipToggle | 2.0.2 | 2.0 | 🟢 |
| Comboboxs | NumberCombobox | 2.0.2 | 2.0 | 🟢 |
| ControlButtons | Checkbox | 2.0.2 | 2.0 | 🟢 |
| ControlButtons | MinusButton | 2.0.2 | 2.0 | 🟢 |
| ControlButtons | Radio | 2.0.2 | 2.0 | 🟢 |
| Datepickers | AnnualDatepicker | 2.0.3 | 2.0 | 🟢 |
| Datepickers | DayDatepicker | 2.0.3 | 2.0 | 🟢 |
| Datepickers | MonthDatepicker | 2.0.3 | 2.0 | 🟢 |
| Datepickers | WeekDatepicker | 2.0.3 | 2.0 | 🟢 |
| Dropdown | Dropdown | 2.0.1 | 2.0 | 🟢 |
| HelperText | HelperText | 2.1.3 | 2.1 | 🟢 |
| Icon | Icon | 2.0.1 | 2.0 | 🟢 |
| Inputs | Input | 2.0.2 | 2.0 | 🟢 |
| Inputs | InputButton | 2.0.2 | 2.0 | 🟢 |
| Inputs | SelectInputButton | 2.0.2 | 2.0 | 🟢 |
| Inputs | TextArea | 2.0.2 | 2.0 | 🟢 |
| List | List | 2.0.3 | 2.0 | 🟢 |
| Menu | Menu | 2.0.1 | 2.0 | 🟢 |
| Modal | Modal | 2.0.1 | 2.0 | 🟢 |
| Pagination | Pagination | 2.0.2 | 2.0 | 🟢 |
| Popper | Popper | 2.0.1 | 2.0 | 🟢 |
| ScrollArea | ScrollArea | 2.0.1 | 2.0 | 🟢 |
| SearchBar | SearchBar | 2.0.2 | 2.0 | 🟢 |
| Skeleton | Skeleton | 2.0.1 | 2.0 | 🟢 |
| Slider | Slider | 2.0.1 | 2.0 | 🟢 |
| Stack | Stack | 2.0.1 | 2.0 | 🟢 |
| StackContainer | StackContainer | 2.0.1 | 2.0 | 🟢 |
| Switch | Switch | 2.0.3 | 2.0 | 🟢 |
| Tabs | Tabs | 2.0.2 | 2.0 | 🟢 |
| Tag | Tag | 2.0.2 | 2.0 | 🟢 |
| Text | Text | 2.0.2 | 2.0 | 🟢 |
| ToggleButton | ToggleButton | 2.0.2 | 2.0 | 🟢 |
| Tooltip | Tooltip | 2.0.2 | 2.0 | 🟢 |
| Tree | Tree | 2.0.2 | 2.0 | 🟢 |

**현황** (메이저·마이너 버전 기준)  
- 🟢 샤플플로우 버전과 디자인 버전의 **메이저·마이너가 동일**함 (예: 2.0.0 vs 2.0 → 🟢)  
- 🔵 **샤플플로우 버전이 더 높음** — 구현이 디자인보다 앞서 있음 (예: 2.1.0 vs 2.0 → 🔵)  
- 🔴 **디자인 버전이 더 높음** — 구현이 디자인보다 뒤처져 있음 (예: 2.0.0 vs 2.1 → 🔴)  

## 업데이트 방법

- **샤플플로우 버전**은 `메이저.마이너.패치`(예: 2.0.0), **디자인 버전**은 `메이저.마이너`(예: 2.0)까지만 적습니다.
- 버전 수정 후 **현황**은 동기화(`version:sync`) 시 자동으로 계산됩니다.
