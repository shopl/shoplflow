...
var require_eslintrc_base = __commonJS({
  ".eslintrc.base.js"(exports, module) {
    module.exports = {
      env: {
        browser: true,
        es6: true,
...
var require_eslintrc_react = __commonJS({
  ".eslintrc.react.js"(exports, module) {
    module.exports = {
...
var require_eslintrc_typescript = __commonJS({
  ".eslintrc.typescript.js"(exports, module) {
    module.exports = {
...
// index.js
var require_eslint_plugin = __commonJS({
...
export default require_eslint_plugin();
