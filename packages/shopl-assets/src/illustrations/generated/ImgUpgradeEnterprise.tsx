...
function SvgImgUpgradeEnterprise(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 48 48' {...props}>
      ...
      <path fill='url(#img-upgrade-enterprise_svg__a)' d='M13 7.6h22l-5.6 20.8H18.6L13 7.6Z' opacity={0.6} />
      <path
        fill='#77D5BB'
      ...
      <defs>
        <linearGradient
          id='img-upgrade-enterprise_svg__a'
          x1={24}
          x2={24}
          y1={7.6}
          y2={28.4}
...
export default createIcon(SvgImgUpgradeEnterprise);
