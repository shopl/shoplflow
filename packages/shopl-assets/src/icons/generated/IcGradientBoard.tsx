...
function SvgIcGradientBoard(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 24 24' {...props}>
      ...
      />
      <circle cx={19.739} cy={4.5} r={2} fill='url(#ic-gradient-board_svg__f)' />
      <defs>
        <linearGradient
        ...
        >
          ...
          <feBlend in2='BackgroundImageFix' result='effect1_dropShadow_286_4513' />
          <feBlend in='SourceGraphic' in2='effect1_dropShadow_286_4513' result='shape' />
        </filter>
      </defs>
    </svg>
  );
