...
function SvgIcBadgeLeaderLarge(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 30 30' {...props}>
      <circle cx={15} cy={15} r={14} fill='#35485B' stroke='#fff' strokeWidth={2} />
      <path
        fill='#fff'
...
export default createIcon(SvgIcBadgeLeaderLarge);
