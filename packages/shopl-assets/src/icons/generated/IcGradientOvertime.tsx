...
function SvgIcGradientOvertime(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 25 25' {...props}>
      ...
      <circle cx={12} cy={19} r={1} fill='url(#ic-gradient-overtime_svg__e)' fillOpacity={0.5} />
      <circle
        cx={18.25}
        cy={18.25}
        r={5.25}
      ...
      <defs>
        ...
        <linearGradient id='ic-gradient-overtime_svg__b' x1={12} x2={12} y1={2} y2={22} gradientUnits='userSpaceOnUse'>
