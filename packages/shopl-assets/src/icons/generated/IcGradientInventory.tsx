...
function SvgIcGradientInventory(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
      ...
      />
      <g opacity={0.3}>
        <path fill="url(#ic-gradient-inventory_svg__c)" fillOpacity={0.8} d="M15 16h4v2h-4v-2Z" />
        <path
      ...
      <defs>
        ...
        <linearGradient id="ic-gradient-inventory_svg__f" x1={12} x2={12} y1={5} y2={12} gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" />
