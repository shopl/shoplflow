  ...
  return (
    ...
    >
      ...
      <rect
        width={6}
        height={3}
        fill="url(#ic-gradient-display_svg__e)"
        rx={0.5}
        transform="matrix(-1 0 0 1 14 6.5)"
      />
      <rect
        width={2}
        height={3}
