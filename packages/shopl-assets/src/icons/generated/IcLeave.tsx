  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
      ...
      <defs>
        ...
        <linearGradient id="ic-leave_svg__c" x1={7.794} x2={12.294} y1={4.5} y2={12.294} gradientUnits="userSpaceOnUse">
          <stop stopColor="#5EDEBE" />
          <stop offset={1} stopColor="#32A88B" />
        </linearGradient>
        <linearGradient id="ic-leave_svg__d" x1={11} x2={12.294} y1={10} y2={12.294} gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" />
        ...
        >
          ...
          <feGaussianBlur result="effect1_foregroundBlur_286_4549" stdDeviation={0.75} />
        </filter>
      </defs>
    </svg>
  );
