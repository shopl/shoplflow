...
function SvgIcGradientNotice(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      />
      <path
        fill="url(#ic-gradient-notice_svg__b)"
        d="M17.5 8.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z"
      />
      <path
        fill="url(#ic-gradient-notice_svg__c)"
        d="M4 9.3a3 3 0 0 1 3-3v9a3 3 0 0 1-3-3v-3Z"
      />
      <path
        fill="url(#ic-gradient-notice_svg__d)"
        d="M7 6.333 16 4v14l-9-2.722V6.333Z"
      />
      <path
        fill="url(#ic-gradient-notice_svg__e)"
        d="M16 18V4l-1 .26V17.7l1 .3Z"
      />
      <path
